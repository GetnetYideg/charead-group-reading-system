...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      login(res.data.data)
      addToast(`Welcome back, ${res.data.data.first_name || res.data.data.username}!`, 'success')
      navigate('/dashboard')
    } catch (err) {
        ...
        <div className="auth-form-container">
          ...
          <form className="auth-form" onSubmit={handleSubmit} noValidate>
            <div className="form-group">
              ...
              <input id="login-username" className={`form-input${errors.username ? ' error' : ''}`} placeholder="your_username" value={form.username} onChange={e => set('username', e.target.value)} />
            ...
            <div className="form-group">
              ...
              <div className="auth-pass-wrap">
                <input id="login-password" type={showPass ? 'text' : 'password'} className={`form-input${errors.password ? ' error' : ''}`} placeholder="••••••••" value={form.password} onChange={e => set('password', e.target.value)} />
          ...
          <p className="auth-switch">Don't have an account? <Link to="/register" className="auth-link">Get started</Link></p>
